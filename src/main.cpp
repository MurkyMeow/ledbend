...
//  float accel_vector_length = sqrt(pow(accel_x,2) + pow(accel_y,2) + pow(accel_z,2));
  ...
  bool state = accel_x > 1000;

  mData color = accel_debounce.isChanged(t_now, state) ? mRGB(255, 0, 0) : mRGB(255, 255, 255); 
